...
const AMEX_DEFAULT_RULES = [
  ...
  ['通信費', 'SLACK,WORKSPACE,ソフトバング,ソフトバンク,楽天モバイル,ＵＱ　ＷｉＭＡＸ,FONDESK,MIXHOST,エックスサーバー,お名前,ロリポップ,ＧａｍｅＷｉｔｈ光'],
  ['支払手数料', 'OPENAI,ANTHROPIC,CLAUDE,AHREFS,MICROSOFT,SHUTTERSTOCK,RAKKO,X CORP,SHOPIFY,PAYPAL,YOUTUBEPREMIUM,ZOOM,NOTION,CANVA,Ａｐｐｌｅ　ｉＴｕｎｅｓ'],
  ['旅費交通費', 'モバイルＳｕｉｃａ,モバイルSuica,モバイルＰＡＳＭＯ,ＧＯアプリ,LUUP,CHARGESPOT,タクシー,駐車場,スマートＥＸ,スマートEX,ＥＴＣ,レンタカー'],
  ['福利厚生費', 'UBER EATS,出前館,でまえかん,ｍｅｎｕ'],
  ['消耗品費', 'アマゾン,ヨドバシ,ビックカメラ'],
  ['外注費', 'クラウドワークス'],
  ['荷造運賃', 'プラスシッピング'],
  ['会議費', 'ｉｎｓｔａｂａｓｅ,貸会議室'],
  ['採用教育費', 'ＯｐｅｎＷｏｒｋ'],
